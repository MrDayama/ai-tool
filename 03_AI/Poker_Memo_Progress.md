...
| **動作検証** | **Undo(1手戻る)機能・All-in Runout自動進行・エッジケース強化** | ✅ 完了 | 2026-08-31 |
| **機能追加** | **ハンドテキスト共有・保存履歴モーダル・JSONバックアップ** | ✅ 完了 | 2026-08-31 |
| **機能追加** | **4×13カードビジュアルピッカー（絵の一覧 ＆ 手入力両対応）** | ✅ 完了 | 2026-08-31 |
| **UI全面刷新** | **ボタン反応バグ完全修復 ＆ 3主要メニュー切り替え（ライブ卓 / 設定 / 履歴&共有）マルチビューへ改修** | **✅ 完了** | **2026-08-31** |
| **Deploy** | **GitHub Pages デプロイ** | ✅ 完了 | 2026-08-31 |
